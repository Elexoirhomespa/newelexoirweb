                    ...
                    <header className="mb-10">
                        ...
                        <p className="text-text-muted text-sm">
                            {activeTab === 'treatment' ? 'Add or edit a massage or ritual to your spa menu.' : 
                             ...
                             activeTab === 'store' ? 'Add physical products like oils or candles to the Therapick Boutique.' :
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="flex bg-white/50 border border-border/50 p-1.5 rounded-2xl w-full max-w-xl shadow-sm mb-6">
                                            {['campaign', 'treatments', 'store'].map((view) => (
                                                ...
                                                >
                                                    {view === 'campaign' ? 'Active Campaign' : view === 'treatments' ? 'Treatments' : 'Therapick Boutique'}
                                                </button>
                                            ))}
                                        </div>
                                        ...
                                        {listView === 'store' && (
                                            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                                ...
                                                <div className="flex items-center justify-between mb-4">
                                                    <h2 className="text-lg font-bold text-primary flex items-center gap-2">
                                                        <Store size={20} className="text-primary" /> Therapick Boutique
                                                    </h2>
